const PARENT_FOLDER_ID = "17GzePxcwvV7CzbXIyJcwzWtyWwNueJ2x";
...
function sendEmail(emailBody) {
  MailApp.sendEmail("info@mastersineurope.in", "New response for LOR/CV Form", emailBody);
  MailApp.sendEmail("swecit-repository@mastersineurope.in", "New response for LOR/CV Form", emailBody);
  MailApp.sendEmail("swec-idf@mastersineurope.in", "New response for LOR/CV Form", emailBody);
}
...
const onFormSubmit = ({ response } = {}) => {
  try {
    ...
    const subfolderName = firstItemAnswer + '-LOR-CV'
